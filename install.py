...
""")
	...
	if system0 == "1":
		...
		install = os.system("sudo apt-get update && sudo apt-get install -y nmap build-essential python-pip ruby-dev git libpcap-dev libgmp3-dev && sudo pip install tabulate terminaltables && sudo pip install python-geoip-geolite2 requests os socket && sudo apt install dnsrecon whois host traceroute")
		...
		install = os.system("sudo apt-get update && sudo apt-get install -y nmap ruby-dev git libpcap-dev libgmp3-dev python-tabulate python-terminaltables && sudo pip install python-geoip-geolite2 requests os socket && sudo apt install dnsrecon whois host traceroute")
